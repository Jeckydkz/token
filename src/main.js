...
class LINE extends LineAPI {
    ...
    poll(operation) {
     ...
     {
let jecky = new Message();
jecky.to = operation.param1;
jecky.text = "Kamvret lu"
...
let jecky= new Message();
jecky.to = operation.param1;
jecky.text = "Jangan utak atik grup woy"
this._client.sendMessage(0,jecky);
     }
            if(!this.isAdminOrBot(operation.param2)){
                this._kickMember(operation.param1,[operation.param2]);
            } 
...
let jecky = new Message();
jecky.to = operation.param1;
jecky.text = "Jangan Main Invite Sembarangan... Siapa Tau Kicker 😧"
